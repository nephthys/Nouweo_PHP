...
function get_news_author($where='', $ordre = 'n_date DESC', $page = '', $element_par_page=0)
{
    ...
    // Rqt SQL
    $rqt_list_news = Nw::$DB->query('SELECT c_id, c_nom, c_rewrite, i_id, i_nom, n_resume, n_nb_votes, n_nb_versions, n_id, n_id_auteur, n_id_cat, n_titre, n_etat, n_vues, n_private, n_nbr_coms,
